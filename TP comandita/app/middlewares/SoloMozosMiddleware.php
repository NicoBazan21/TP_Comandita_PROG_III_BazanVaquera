        ...
        {   try
            {
                ...
                {
                    $payload = json_encode(array("Estado:"=>"Rechazado", "area del token:"=>$datos->data->area, "Detalle:"=>"area no coincidente"));
            ...
            {
                $payload = json_encode(array("Estado:"=>"JWT invalido"));
